...
const COURSES = [
  { id: "c1", title: "Toán học cơ bản", description: "Học toán vui nhộn với trò chơi và hình ảnh sinh động", image: "/images/home/Asset 97.svg", level: "Cơ bản", duration: "4 tuần", students: 2590, rating: 4.7, price: 390000, badge: "bg-blue-100 text-blue-800" },
  { id: "c2", title: "Tiếng Anh cho trẻ em", description: "Phát triển kỹ năng tiếng Anh qua câu chuyện và bài hát", image: "/images/home/Asset 98.svg", level: "Sơ cấp", duration: "5 tuần", students: 2180, rating: 4.8, price: 450000, badge: "bg-green-100 text-green-800" },
  { id: "c3", title: "Khoa học thú vị", description: "Khám phá thế giới khoa học qua thí nghiệm đơn giản", image: "/images/home/Asset 99.svg", level: "Trung cấp", duration: "7 tuần", students: 650, rating: 4.7, price: 420000, badge: "bg-purple-100 text-purple-800" },
  { id: "c4", title: "Thiên văn nhập môn", description: "Làm quen bầu trời đêm qua các hoạt động trực quan", image: "/images/home/Asset 97.svg", level: "Sơ cấp", duration: "4 tuần", students: 880, rating: 4.6, price: 410000, badge: "bg-pink-100 text-pink-800" },
];
      ...
      <div className="relative z-10 container mx-auto px-16 my-24">
        ...
        <div className="text-center mb-10 md:mb-14">
          <div className="inline-flex items-center justify-center">
            <img src="/images/home/Asset 100.svg" alt="graduation-hat" className="w-36 h-20" />
          </div>
          <h2 className="text-3xl md:text-4xl font-bold mb-2 font-montserrat">Khóa học phổ biến</h2>
            ...
            {COURSES.map((c) => (
              <CarouselItem key={c.id}>
                ...
                <div className="p-3 md:p-3.5 lg:p-4 h-full">
                  <Card className="h-full rounded-[28px] overflow-hidden border border-[#e9eef5] bg-white">
                    {/* Ảnh minh họa */}
                    ...
                    <CardHeader className="px-6 pt-4 pb-0">
                      <CardTitle className="text-[22px] md:text-2xl font-extrabold leading-snug text-slate-900">
                        {c.title}
                      </CardTitle>
                    </CardHeader>
                    ...
                    <CardContent className="px-6 pb-6 pt-3">
                      ...
                      <ul className="space-y-3 text-[14px] text-slate-400 mb-5">
                        <li className="flex items-center gap-2">
                          <Users className="h-4 w-4" />
                          <span>{c.students.toLocaleString()} học sinh đã tham gia</span>
                        </li>
                        <li className="flex items-center gap-2">
